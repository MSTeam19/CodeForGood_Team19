...
function Home() {
  ...
  const missionCards = [
    {
      ...
      description:
        'Providing quality educational resources and mentorship programs to unlock potential in every student.',
    ...
    },
    {
      ...
      description:
        'Fostering inclusive communities where everyone has the opportunity to thrive and contribute.',
    ...
    },
    {
      ...
      description:
        'Empowering individuals with modern skills and innovative approaches to break barriers.',
    ...
    },
    {
      ...
      description:
        'Creating lasting change through sustainable programs that grow with our communities.',
  ...
  const impactStories = [
    {
      ...
      age: 16,
      story:
        'REACH helped me discover my passion for coding. Now I mentor other students in my community.',
    ...
    },
    {
      ...
      age: 14,
      story:
        'The after-school program gave me a safe place to learn and make friends when my family was struggling.',
    ...
    },
    {
      ...
      age: 17,
      story:
        'Thanks to REACH, I received a scholarship to study at university. I want to become a teacher.',
  ...
  return (
    <div className="home-root">
      ...
      <div
        className={`floating-donate-btn ${showFloatingButton ? 'visible' : ''}`}
      >
        <a
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p className="hero-subtitle">
              Join REACH in building stronger, more inclusive communities across
              Hong Kong through education, outreach, and empowerment.
            </p>
          ...
          <div className="hero-stats">
            <div className="floating-stat">
              ...
              <span
                className="stat-number hero-stat-number"
                style={{
                  color: '#FFFFFF',
              ...
              >
                {impactStats[currentStat].number}
              </span>
              <span
          ...
          <div className="thermometer-widget">
            <div className="thermometer">
              <div
                ...
                style={{ height: `${donationProgress.percentage}%` }}
              ></div>
              <div className="thermometer-bulb"></div>
            </div>
            <div className="thermometer-labels">
              <div className="current-amount">
                HK${(donationProgress.current / 1000).toFixed(0)}K
              </div>
              <div className="goal-amount">
                Goal: HK${(donationProgress.goal / 1000).toFixed(0)}K
              </div>
              <div className="percentage">
                {Math.round(donationProgress.percentage)}% Complete
              </div>
            </div>
            <div className="thermometer-description">
              <p>
                Every donation brings us closer to providing quality education
                resources for 3,000+ students across Hong Kong.
              </p>
              <a
                href="https://reachhk.squarespace.com/"
                target="_blank"
          ...
          <div className="champion-widget">
            <div className="champion-card-spotlight">
              <div className="champion-avatar-large">
                <img
                  src={champions[currentChampion].photo}
              ...
              <div className="champion-content">
                ...
                <p className="champion-role">
                  {champions[currentChampion].role}
                </p>
                ...
                <div className="champion-impact">
                  <span className="impact-stat">
                    {champions[currentChampion].impact}
                  </span>
                </div>
                <div className="champion-actions">
                  <a href="/champion" className="join-champions-btn">
                    Become a Champion
                  </a>
                  <a href="/leaderboard" className="view-all-btn">
                    View All Champions
                  </a>
                </div>
              </div>
      ...
      <section id="impact-stories-section" className="impact-stories-section">
        <div className="impact-stories-container">
          ...
          <p className="section-subtitle">
            Meet the students whose lives have been transformed through REACH
            programs
          </p>
