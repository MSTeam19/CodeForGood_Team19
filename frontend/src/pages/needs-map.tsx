...
function selectSummary(data: LeaderboardResponse): {
  totalAmountCents: number;
  donationCount: number;
} {
    ...
    <div className="detail-panel">
      ...
      <div className="detail-content">
        ...
        <div className="detail-actions">
          ...
          <a
            href={`/leaderboard?country=${country}&region=${region.regionId}`}
...
export default function NeedsMap() {
  ...
  useEffect(() => {
    if (!mapboxToken || !mapContainer.current || !data || !window.mapboxgl)
      return;
